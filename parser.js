...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c0 = function(parts) { return "with(data){var out='" + parts.join('') + "';return out;}" },
      peg$c1 = "@",
      ...
      peg$c19 = function(value) { return "';" + value + ";out+='" },
      peg$c20 = ".",
  ...
  function peg$parseExpression() {
    ...
    if (s1 !== peg$FAILED) {
      ...
      if (s4 === peg$FAILED) {
        s4 = peg$parseJsString();
        if (s4 === peg$FAILED) {
          s4 = peg$parseJsComment();
          if (s4 === peg$FAILED) {
            s4 = peg$parseJsRegex();
            if (s4 === peg$FAILED) {
